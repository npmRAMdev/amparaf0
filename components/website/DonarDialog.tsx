...
//console.log('---Donacio en DonarDialog:---', donacio)
  ...
  return (
    <div className="col-span-12 sm:col-span-6 flex flex-col p-2 sm:p-4 relative items-center justify-center bg-stone-6 shadow-md rounded-xl">
        <div className="text-center py-4 sm:p-4 flex flex-col h-full"> 
            <div className="flex flex-col mb-5 sm:mb-3">
                ...
                <div className="flex justify-center mt-auto"> 
                    <Link href={donacio.url} target="_blank" rel="noopener noreferrer" className="flex justify-between items-center gap-2 bg-emerald-400 hover:bg-emerald-300 px-5 py-2 text-md shadow-sm hover:shadow-md font-medium tracking-wider text-stone-50 rounded-full transition ease-in duration-300 animate-pulse">
